		...
		private void BarrageImage(string imageIndex)
		{
			try
			{
				...
				switch (imageIndex)
				{
					...
					break;
					case "11":
					data = Properties.Resources.koreaFuck;
					break;
					case "12":
					data = Properties.Resources.dog;
					break;
					case "bug":
				...
				Application.Current.Dispatcher.Invoke(() =>
				{
					...
					animation.Completed += (object sender, EventArgs e) => { canvas.Children.Remove(img); };
					//启动动画
			...
			try
			{
				...
				foreach (var item in contentlist)
				{
					...
					Application.Current.Dispatcher.Invoke(() =>
					{
						...
						animation.To = canvas.ActualWidth;
						animation.Duration = TimeSpan.FromSeconds(10);
						animation.Completed += (object sender, EventArgs e) => { canvas.Children.Remove(textblock); };
						//启动动画
